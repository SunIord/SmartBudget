...
void AppUI2::handleMenuOption(int option) {
    switch (option) {
...
void AppUI2::filterByAmountRange() {
    double min, max;
...
void AppUI2::switchTransactionFile() {
...
void AppUI2::deleteTransactionFile() {
    std::cout << "\nAvailable CSV files:\n";
    DIR* dir;
    struct dirent* entry;
    dir = opendir(".");
